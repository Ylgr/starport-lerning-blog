...
import { Comment } from "../starportlerningblog/comment";
import { PageRequest, PageResponse, } from "../cosmos/base/query/v1beta1/pagination";
import { Post } from "../starportlerningblog/post";
export const protobufPackage = "ylgr.starportlerningblog.starportlerningblog";
...
export class QueryClientImpl {
    ...
    Comment(request) {
        ...
        const promise = this.rpc.request("ylgr.starportlerningblog.starportlerningblog.Query", "Comment", data);
    ...
    CommentAll(request) {
        ...
        const promise = this.rpc.request("ylgr.starportlerningblog.starportlerningblog.Query", "CommentAll", data);
    ...
    Post(request) {
        ...
        const promise = this.rpc.request("ylgr.starportlerningblog.starportlerningblog.Query", "Post", data);
        return promise.then((data) => QueryGetPostResponse.decode(new Reader(data)));
    }
    PostAll(request) {
        const data = QueryAllPostRequest.encode(request).finish();
        const promise = this.rpc.request("ylgr.starportlerningblog.starportlerningblog.Query", "PostAll", data);
